...
class ScienceFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        data.add(BukuModel(R.drawable.book9, "Emi's fhdhjafjhgrj", "dhgfhdsafhdbhfvsanbvvhvdhvhvffa"))
        data.add(BukuModel(R.drawable.book10, "Ryan's dhjgffdgffg", "dgjgjsadgfkdshfhgsfgyuwetaeutyfry"))
